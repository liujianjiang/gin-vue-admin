...
[审批流分支](https://github.com/liujianjiang/gin-vue-admin/tree/gva_workflow): https://github.com/liujianjiang/gin-vue-admin/tree/gva_workflow
...
- restful示例：可以参考用户管理模块中的示例API。
	- 前端文件参考: [web/src/view/superAdmin/api/api.vue](https://github.com/liujianjiang/gin-vue-admin/blob/master/web/src/view/superAdmin/api/api.vue)
    - 后台文件参考: [server/router/sys_api.go](https://github.com/liujianjiang/gin-vue-admin/blob/master/server/router/sys_api.go)
