...
[Vue3 version branch address](https://github.com/liujianjiang/gin-vue-admin/tree/vue3Develop): https://github.com/liujianjiang/gin-vue-admin/tree/vue3Develop

[Approval flow branch](https://github.com/liujianjiang/gin-vue-admin/tree/gva_workflow): https://github.com/liujianjiang/gin-vue-admin/tree/gva_workflow
...
- [gin-vue-admin_v2_dev](https://github.com/liujianjiang/gin-vue-admin/tree/gin-vue-admin_v2_dev) (v2.0 [GormV1](https://v1.gorm.io) Stable branch)
- [gva_gormv2_dev](https://github.com/liujianjiang/gin-vue-admin/tree/gva_gormv2_dev) (v2.0 [GormV2](https://v2.gorm.io) Development branch)
...
- Restful example: You can see sample APIs in user management module.
  - Front-end file reference: [web/src/view/superAdmin/api/api.vue](https://github.com/liujianjiang/gin-vue-admin/blob/master/web/src/view/superAdmin/api/api.vue).
  - Stage reference: [server/router/sys_api.go](https://github.com/liujianjiang/gin-vue-admin/blob/master/server/router/sys_api.go).
...
<a href="https://github.com/liujianjiang/gin-vue-admin/graphs/contributors">
