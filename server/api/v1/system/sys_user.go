...
import (
	...
	"github.com/liujianjiang/gin-vue-admin/server/global"
	"github.com/liujianjiang/gin-vue-admin/server/model/common/request"
	"github.com/liujianjiang/gin-vue-admin/server/model/common/response"
	"github.com/liujianjiang/gin-vue-admin/server/model/system"
	systemReq "github.com/liujianjiang/gin-vue-admin/server/model/system/request"
	systemRes "github.com/liujianjiang/gin-vue-admin/server/model/system/response"
	uti "github.com/liujianjiang/gin-vue-admin/server/plugin/email/utils"
	"github.com/liujianjiang/gin-vue-admin/server/utils"
...
func (b *BaseApi) SendEmail(c *gin.Context) {
	...
	for _, code := range codes {
		...
		stockinfo, err := userService.GetTTJiJinStockInfo((int(code)))
		if err != nil {
			log.Fatal(err)
		}
